...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright)):
					...
					echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="http://themeisle.com/themes/zerif-lite/"'.$attribut_new_tab.' rel="nofollow">TGD </a>'.__('Done by','zerif-lite').'<a class="zerif-copyright" href="http://wordpress.org/"'.$attribut_new_tab.' rel="nofollow"> The Graphic Designer</a></div>';
